...
namespace BGC.Annotation.Basic
{
    ...
    public class Polyline : Annotation
    {
        ...
        public static Polyline Instance { get { return Nested.instance; } }
        ...
        private class Nested
        {
            ...
            internal static readonly Polyline instance = new Polyline();
        }
        ...
        public GameObject InstantiateFromEventData( InputClickedEventData eventData)
        {
                ...
                Physics.DefaultRaycastLayers))
            {
                ...
                //Debug.Log("newPOint.tag = " + newPoint.tag);
                numPoints++;
        ...
        public static void Done()
        {
                ...
                Debug.Log("instance.transform.childCount = " + count);
                for (int i = 0; i < count; i++)
                    {
                        Transform child = instance.transform.GetChild(i);
                       Debug.Log("Polyline.Done.child.name = " + child.name);
        ...
        public AnnotationEntity MakeAnnotationEntity(GameObject gameObject)
        {
            ...
            annotationEntity.type = "polyline";
        ...
        public static bool Undo()
        {
            ...
            if (undoStack.Count > 0) {
                ...
                Debug.Log("Vector3 position = point.transform.position;");
