...
namespace HoloToolkit.Unity.InputModule.Utilities.Interactions
{
    ...
    public class TwoHandManipulatableCustom : MonoBehaviour, IInputHandler, ISourceStateHandler
    {
        ...
        public void SetManipulationMode(string mode)
        {
            switch (mode.ToLower())
            {
                case "rotate":
                    ManipulationMode = TwoHandedManipulation.Rotate;
                    break;
                case "scale":
                    ManipulationMode = TwoHandedManipulation.Scale;
                    break;
                case "rotate x":
                    ManipulationMode = TwoHandedManipulation.Rotate;
                    m_rotateLogic = new TwoHandRotateLogic(AxisConstraint.XAxisOnly);
                    break;
                case "rotate y":
                    ManipulationMode = TwoHandedManipulation.Rotate;
                    m_rotateLogic = new TwoHandRotateLogic(AxisConstraint.YAxisOnly);
                    break;
                case "rotate z":
                    ManipulationMode = TwoHandedManipulation.Rotate;
                    m_rotateLogic = new TwoHandRotateLogic(AxisConstraint.ZAxisOnly);
                    break;
            }
        }
        ...
        private bool OneHandMovement = false;
        ...
        private void Update()
        {
            ...
            {
                Debug.Log("Manipulation mode: " + ManipulationMode + ", Current State: " + currentState);
