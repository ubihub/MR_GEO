...
namespace HoloToolkit.Examples.InteractiveElements
{
    ...
    public class Interactive : MonoBehaviour, IInputClickHandler, IFocusable, IInputHandler
    {
        ...
        public virtual void OnInputClicked(InputClickedEventData eventData)
        {
            ...
            //OnSelectEvents.AddListener(aFunction);
            //Debug.Log(OnSelectEvents.GetPersistentEventCount());
            //Debug.Log(OnSelectEvents.GetPersistentMethodName(0));
            //Debug.Log(OnSelectEvents.GetPersistentMethodName(1));
            Debug.Log("In " + name + " button OnInputClicked");
        ...
        public virtual void OnInputDown(InputEventData eventData)
        {
            ...
            Debug.Log("In " + name + " button OnInputDown");
            OnDownEvent.Invoke();
        }
